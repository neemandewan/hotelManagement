...
public class HotelController {
    ...
    public @ResponseBody
    Response<Hotel> addHotel(@PathVariable("userId") Long userId, @Valid @RequestBody HotelDTO hotelDTO) {
    ...
    @RequestMapping(value="/{userId}/{hotelId}", method = RequestMethod.PUT, consumes = MediaType.APPLICATION_JSON_VALUE)
    public @ResponseBody
    Response<Hotel> updateHotel(@PathVariable("userId") Long userId, @PathVariable("hotelId") Long hotelId, @Valid @RequestBody HotelDTO hotelDTO) {
        System.out.println(hotelDTO);
    ...
    @RequestMapping(value="/{userId}/{hotelId}", method = RequestMethod.DELETE, consumes = MediaType.APPLICATION_JSON_VALUE)
    public @ResponseBody
    Response<Hotel> delHotel(@PathVariable("userId") Long userId, @PathVariable("hotelId") Long hotelId) {
    ...
    @RequestMapping(value="/{hotelId}/image/{id_image}", method=RequestMethod.DELETE)
    public @ResponseBody
